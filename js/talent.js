...
new Talent({
    ...
    max_points_fn: function(game) {
        return Math.min(4, Math.floor(game.level() / 10) + 1);
    }
});
...
new Talent({
    ...
    min_level: 20,
    max_points_fn: function(game) {
        return Math.min(Math.max(0,game.max_infused_tier()-1), Math.floor((game.level() - 20)/ 20 + 1));
    }
});
...
new Talent({
    ...
    min_level: 30,
    max_points_fn: function(game) {
        return Math.min(Math.max(0,game.max_infused_tier()-1), Math.floor((game.level() - 30)/ 20 + 1));
    }
});
...
new Talent({
    ...
    min_level: 10,
    max_points_fn: function(game) {
        return Math.min(Math.max(0,game.max_infused_tier()-1), Math.floor((game.level() - 10)/ 20 + 1));
    }
});
