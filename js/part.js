Part = Ice.$extend('Part', {
    ...
    raph: function(element, raph) {
        ...
        if(Ice.isa(self, ConduitPart)) {
            ...
            colors = ['#111', '#fbb000', '#111', '#111', '#fbb000', '#111'];
...
FractalPart = Part.$extend('FractalPart', {
    __init__: function() {
        ...
        self.name = ko.observable('Fractal Crystal');
    },
    __keys__: function() {
...
ConduitPart = Part.$extend('ConduitPart', {
    __init__: function() {
        ...
        self.name = ko.observable('Conduit Crystal');
...
BlankGeneratorPart = Part.$extend('BlankGeneratorPart', {
    __init__: function() {
        ...
        self.name = ko.observable('Blank Crystal Generator');
        self.max_refinement = ko.observable(0);
...
CapacitorPart = Part.$extend('CapacitorPart', {
    __init__: function() {
        ...
        self.name = ko.observable('Capacitor Crystal');
        self.max_refinement = ko.observable(0);
...
HopperPart = Part.$extend('HopperPart', {
    __init__: function() {
        ...
        self.name = ko.observable('Hopper Crystal');
        self.max_refinement = ko.observable(0);
    ...
    reverse_apply: function(game) {
        ...
        if(game.dragging_part() === islot.part())
            interact.stop();
...
RelayPart = Part.$extend('RelayPart', {
    __init__: function() {
        ...
        self.name = ko.observable('Relay Crystal');
        self.max_refinement = ko.observable(0);
