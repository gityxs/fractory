...
var cnItems = {
    ...
    "Arcana\n                    (": "至宝\n (",
    "Ascend": "登高",
    "Ascend now, increasing level by": "现在上升，等级增加",
    "at Level": "在级别",
    ...
    "Experience gained from spent Arcana:": "从使用的至宝中获得的经验：",
    "Fractals": "分形",
    "Full Reset": "完全重置",
    ...
    "Place a simple Arcana crystal.": "放置一个简单的至宝水晶。",
    "Place a simple Glow crystal.": "放置一个简单的辉光水晶。",
    ...
    "You will lose all crystals and enchant upgrades when you ascend.": "提升时，您将失去所有水晶和附魔升级。",
    "Zoom Out": "缩小",
    "": "",
    "": "",
    "": "",
